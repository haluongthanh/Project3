        ...
        <div className='container-fluid'>
          ...
          <div className='row-header'>
            <div className='mobile-menu'>
              <DrawerMenu website={website} user={user}/>
            </div>
            ...
            <div className='coll-header main-header--right header-action'>
              <SearchBar />
              <div class="header-action-item main-header--home hide-mb">
              ...
              <div class="header-action-item main-header--blog hide-mb">
                <div className='header-action_text'>
                  <a href='/blogs/all' className='header-action__link'>
              ...
              <div class="header-action-item main-header--ordertracking  hide-mb">
                <div className='header-action_text'>
                  <a href='#' onClick={handleOrderTrackingClick} className='header-action__link'>
            ...
            <div class="header-action-item main-header--info hide-mb">
              <div className='header-action_text'>
                <a href={`tel:${website[0]?.hotline}`} className='header-action__link'>
                  <span class="icon">
            ...
            <div className='secondary-menu'>
              <div className='cart-area'>
                <Tooltip title='Your cart'>
                  <a href='/cart' style={{ padding: '8px 15px' }}>
