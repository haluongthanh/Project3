                                ...
                                <div class="right-main-box">
                                    <div class="box-heading">
                                        <div class="line-title">
                                            <h2>Chi tiết đơn hàng #{order.orderCode} - <span class="order-status">{order.orderStatus}</span></h2>
                                    ...
                                    <div class="box-info-account">
                                        ...
                                        <div id="order_info" className="order-info">
                                            ...
                                            <div class="summary-action">
                                                <button type="button" id="checkout" class="btn-checkout button" name="checkout" value=" " onClick={submitHandler}> Cập nhật trạng thái</button>
                                            </div>
                                                            ...
                                                            <div class="order-group single">
                                                                <div id="1805774830" data-vrid="1106689042" data-prid="1047269702" class="line-item">
                                                                    <div class="left"><div class="image">
                                                                        <img src={IMAGE_BASEURL + item.product.images[0].url} alt={item.title} />                                                        </div><div class="info">
